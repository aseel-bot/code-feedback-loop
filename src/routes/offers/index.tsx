...
export const Route = createFileRoute("/offers/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "اطلع على عروض نجم الشارقة للسيارات: خصم الضريبة، دفعات أولى رمزية وخطط تمويل مرنة.",
      },
      { property: "og:title", content: "عروض سيارات حصرية | نجم الشارقة للسيارات" },
